...
<div class="admindiv"><a href="admindash.php" class="acolor" style="padding-left: 2%">Back</a><span style="padding-left: 31%">WELCOME TO ADMIN DASHBOARD<span> <span style="padding-left: 30%"><a href="logout.php" class="acolor">Log Out</a></span></div>